...
const commands = [
  ...
  { cmd: "skills", output: "Languages: C++, Java, Python, JavaScript, Dart, HTML/CSS\nFrameworks: ReactJS, Flutter, Tailwind CSS, Framer Motion\nTools: VS Code, GitHub, Postman, Android Studio, Firebase, AWS, Vercel / Render, Google Colab\nDatabases: MongoDB, MySQL, PostgreSQL, Firestore" },
